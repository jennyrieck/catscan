...
#' to handle standalone strings, case sensitivity, and basic pluralization.
...
#' @examples
#' KEYWORDS_DF <- mk_keyword_search_keycode(c("courriel", "e[-]?mail"),
#'                                 STANDALONE = TRUE, IGNORE_CASE = TRUE, MAKE_PLURAL = TRUE)
#'
